...
def categorize_students(input_file, output_xlsx, output_docx, outstanding_min, good_min):
    try:
...
def start_categorization():
    ...
    try:
        ...
        categorize_students(input_file, output_xlsx, output_docx, outstanding_min, good_min)
...
tk.Label(root, text="Minimum Marks for Outstanding:", font=("Arial", 11, "bold"), bg="white").place(x=40, y=120)
entry_outstanding = tk.Entry(root, width=10, relief="solid")
entry_outstanding.place(x=320, y=120)

tk.Label(root, text="Minimum Marks for Good:", font=("Arial", 11, "bold"), bg="white").place(x=40, y=160)
entry_good = tk.Entry(root, width=10, relief="solid")
